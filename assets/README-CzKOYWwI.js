import{_ as l,d as h,c as g,a as t,w as a,v as i,b as p,e as r,r as b,o as y}from"./sites-_W3AzEs2.js";import{P as u}from"./prism-bash-zcnM7wlG.js";const f=`<template>
  <view>
    <t-empty
...
`,v=h({data(){return{DemoexamplebaseCode:f,DemoexampleimageEmptyCode:_,DemoexamplebuttonEmptyCode:E}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(e){this.$route.query.tab!==e&&this.$router.push({query:{tab:e}})}}},mounted(){const{tdDocContent:e,tdDocHeader:n,tdDocTabs:o,tdDocPhone:d}=this.$refs,m="https://novlan1.github.io/tdesign-uniapp#/pages-more/empty/empty";n&&(n.docInfo={title:"Empty 空状态",desc:"用于空状态时的占位提示。"}),o&&(o.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],o.onchange=({detail:c})=>this.tab=c),d&&(d.qrcodeUrl=m),u.highlightAll(),this.$emit("loaded",()=>{e.pageStatus="show"})}}),D={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},x={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"data","component-name":"empty"},k=["tab"],w={name:"DEMO"},S=p(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>全局引入，在 miniprogram 根目录下的<code>app.json</code>中配置，局部引入，在需要引入的页面或组件的<code>index.json</code>中配置。</p><div class="language-json"><pre><code><span class="token property">&quot;usingComponents&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
