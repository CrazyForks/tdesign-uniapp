import{_ as h,d as u,c as g,a as e,w as l,v as i,b as s,e as n,f as c,r as v,o as b}from"./sites-taiaIPy6.js";import{P as f}from"./prism-bash-zcnM7wlG.js";const _=`<template>
  <view class="wrapper">
    <t-slider
      :default-value="23"
      :step="0.1"
...
`,S=u({data(){return{DemoexamplebaseCode:_,DemoexamplerangeCode:w,DemoexamplelabelCode:k,DemoexamplestepCode:E,DemoexampledisabledCode:D,DemoexamplecapsuleCode:y,DemoexampleverticalCode:x}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(t){this.$route.query.tab!==t&&this.$router.push({query:{tab:t}})}}},mounted(){const{tdDocContent:t,tdDocHeader:o,tdDocTabs:a,tdDocPhone:r}=this.$refs,p="https://novlan1.github.io/tdesign-uniapp#/pages-more/slider/slider";o&&(o.docInfo={title:"Slider 滑动选择器",desc:"用于选择横轴上的数值、区间、档位。"}),a&&(a.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],a.onchange=({detail:m})=>this.tab=m),r&&(r.qrcodeUrl=p),f.highlightAll(),this.$emit("loaded",()=>{t.pageStatus="show"})}}),A={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},C={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"data","component-name":"slider"},M=["tab"],R={name:"DEMO"},N=s(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>全局引入，在 miniprogram 根目录下的<code>app.json</code>中配置，局部引入，在需要引入的页面或组件的<code>index.json</code>中配置。</p><div class="language-json"><pre><code><span class="token property">&quot;usingComponents&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  <span class="token property">&quot;t-slider&quot;</span><span class="token operator">:</span> <span class="token string">&quot;tdesign-miniprogram/slider/slider&quot;</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="代码演示">代码演示 <a class="header-anchor" href="#代码演示"></a></h2><img src="https://tdesign.gtimg.com/miniprogram/readme/slider.png" width="375px" height="50%"><p><a href="https://developers.weixin.qq.com/s/2p6gkime7CSn" title="在开发者工具中预览效果" target="_blank" rel="noopener noreferrer"> 在开发者工具中预览效果 </a></p><blockquote style="background-color:#d9e1ff;font-size:15px;line-height:26px;margin:16px 0 0;padding:16px;border-radius:6px;color:#0052d9;"><p>Tips: 请确保开发者工具为打开状态。导入开发者工具后，依次执行：npm i &gt; 构建npm包 &gt; 勾选 &quot;将JS编译成ES5&quot;</p></blockquote><h3 id="组件类型">组件类型 <a class="header-anchor" href="#组件类型"></a></h3><p>单游标滑块</p>`,9),q={class:"tdesign-demo-wrapper tdesign-demo-item-- README-base tdesign-demo-item-- README"},$=["code"],V={slot:"action"},T=e("p",null,"双游标滑块",-1),j={class:"tdesign-demo-wrapper tdesign-demo-item-- README-range tdesign-demo-item-- README"},B=["code"],P={slot:"action"},z=e("p",null,"带数值滑动选择器",-1),I={class:"tdesign-demo-wrapper tdesign-demo-item-- README-label tdesign-demo-item-- README"},O=["code"],F={slot:"action"},H=e("p",null,"带刻度滑动选择器",-1),U={class:"tdesign-demo-wrapper tdesign-demo-item-- README-step tdesign-demo-item-- README"},G=["code"],J={slot:"action"},Q=e("h3",{id:"组件状态"},[c("组件状态 "),e("a",{class:"header-anchor",href:"#组件状态"})],-1),K=e("p",null,"滑块禁用状态",-1),L={class:"tdesign-demo-wrapper tdesign-demo-item-- README-disabled tdesign-demo-item-- README"},W=["code"],X={slot:"action"},Y=e("h4",{id:"特殊样式"},[c("特殊样式 "),e("a",{class:"header-anchor",href:"#特殊样式"})],-1),Z=e("p",null,"胶囊型滑块",-1),ee={class:"tdesign-demo-wrapper tdesign-demo-item-- README-capsule tdesign-demo-item-- README"},te=["code"],de={slot:"action"},ne=e("h4",{id:"垂直状态"},[c("垂直状态 "),e("a",{class:"header-anchor",href:"#垂直状态"})],-1),ae=e("p",null,"垂直方向的滑块",-1),se={class:"tdesign-demo-wrapper tdesign-demo-item-- README-vertical tdesign-demo-item-- README"},oe=["code"],re={slot:"action"},le=s(`<h2 id="faq">FAQ <a class="header-anchor" href="#faq"></a></h2><p>当 slider 外层使用 <code>hidden</code> 包裹，需要在 <code>hidden = false</code> 时，重新调用组件的 <code>init</code> 方法，才能正常渲染（在t-popup/t-dialog中同理）。如下：</p><div class="language-html"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>t-slider</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>slider<span class="token punctuation">&quot;</span></span> <span class="token punctuation">/&gt;</span></span>
