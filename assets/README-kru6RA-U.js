import{_ as h,d as g,c as u,a as t,w as s,v as c,b as l,e as o,f as n,r as b,o as v}from"./sites-DNPg1eh9.js";import{P as f}from"./prism-bash-zcnM7wlG.js";const _=`<template>
  <view>
    <t-radio-group
      allow-uncheck
      :value="current"
...
`,w=g({data(){return{DemoexamplebaseCode:_,DemoexamplehorizontalCode:y,DemoexamplestatusCode:k,DemoexamplethemeCode:R,DemoexamplealignCode:E,DemoexamplecardCode:x,DemoexamplespecialCode:D}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(e){this.$route.query.tab!==e&&this.$router.push({query:{tab:e}})}}},mounted(){const{tdDocContent:e,tdDocHeader:r,tdDocTabs:a,tdDocPhone:i}=this.$refs,p="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/radio/radio";r&&(r.docInfo={title:"Radio 单选框",desc:"用于在预设的一组选项中执行单项选择，并呈现选择结果。"}),a&&(a.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],a.onchange=({detail:m})=>this.tab=m),i&&(i.qrcodeUrl=p),f.highlightAll(),this.$emit("loaded",()=>{e.pageStatus="show"})}}),N={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},A={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"form","component-name":"radio"},C=["tab"],S={name:"DEMO"},M=l(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TRadio <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/radio/radio.vue&#39;</span><span class="token punctuation">;</span>
