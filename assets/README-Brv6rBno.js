import{_ as l,d as p,c as h,a as t,w as s,v as a,b as r,e as d,f as b,r as u,o as x}from"./sites-3xGvLtLV.js";import{P as v}from"./prism-bash-zcnM7wlG.js";const f=`<template>
  <view>
    <t-grid
      class="block"
      :column="5"
...
`,I=p({data(){return{DemoexamplebaseCode:f,DemoexampledescriptionCode:_,DemoexampleborderCode:E,DemoexamplebadgeCode:y,DemoexamplescrollCode:D,DemoexampleicongridCode:w,DemoexamplemultipleCode:k,DemoexamplecardCode:G}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(e){this.$route.query.tab!==e&&this.$router.push({query:{tab:e}})}}},mounted(){const{tdDocContent:e,tdDocHeader:o,tdDocTabs:i,tdDocPhone:m}=this.$refs,g="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/grid/grid";o&&(o.docInfo={title:"Grid 宫格",desc:"用于功能入口布局，将页面或特定区域切分成若干等大的区块，形成若干功能入口。"}),i&&(i.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],i.onchange=({detail:c})=>this.tab=c),m&&(m.qrcodeUrl=g),v.highlightAll(),this.$emit("loaded",()=>{e.pageStatus="show"})}}),A={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},C={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"data","component-name":"grid"},M=["tab"],R={name:"DEMO"},N=r(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TGrid <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/grid/grid.vue&#39;</span><span class="token punctuation">;</span>
