import{_ as h,d as p,c as b,a as t,w as s,v as i,b as l,e as n,f as m,r as u,o as v}from"./sites-DDA63Ty2.js";import{P as f}from"./prism-bash-zcnM7wlG.js";const x=`<template>
  <view>
    <view class="demo">
...
`,E=p({data(){return{DemoexampletypeCode:x,DemoexampleclosableCode:k,DemoexamplecheckableCode:w,DemoexamplethemeCode:y,DemoexamplesizeCode:_}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(d){this.$route.query.tab!==d&&this.$router.push({query:{tab:d}})}}},mounted(){const{tdDocContent:d,tdDocHeader:r,tdDocTabs:a,tdDocPhone:o}=this.$refs,c="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/tag/tag";r&&(r.docInfo={title:"Tag 标签",desc:"用于表明主体的类目，属性或状态。"}),a&&(a.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],a.onchange=({detail:g})=>this.tab=g),o&&(o.qrcodeUrl=c),f.highlightAll(),this.$emit("loaded",()=>{d.pageStatus="show"})}}),z={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},D={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"data","component-name":"tag"},C=["tab"],S={name:"DEMO"},T=l(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TTag <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/tag/tag.vue&#39;</span><span class="token punctuation">;</span>
