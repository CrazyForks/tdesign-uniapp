import{_ as m,d as h,c as u,a as t,w as s,v as a,b as p,e as i,r as f,o as b}from"./sites-CW8c24Yg.js";import{P as g}from"./prism-bash-zcnM7wlG.js";const _=`<template>
  <view>
    <t-row>
      <t-col
        span="8"
...
</code></pre></div><h3 id="组件类型">组件类型 <a class="header-anchor" href="#组件类型"></a></h3><p>基础</p>`,5),C={class:"tdesign-demo-wrapper tdesign-demo-item-- README-base tdesign-demo-item-- README"},R=["code"],N={slot:"action"},A=t("p",null,"增加间距",-1),M={class:"tdesign-demo-wrapper tdesign-demo-item-- README-offset tdesign-demo-item-- README"},S=["code"],$={slot:"action"},P={ref:"tdDocPhone"},j=t("iframe",{src:"https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/col/col",frameborder:"0",width:"100%",height:"100%",style:{"border-radius":"0 0 6px 6px"}},null,-1),O=[j],q=t("td-contributors",{platform:"mobile",framework:"uniapp","component-name":"col"},null,-1),z={name:"API"},I=p('<h3 id="col-props">Col Props <a class="header-anchor" href="#col-props"></a></h3><table><thead><tr><th>名称</th><th>类型</th><th>默认值</th><th>描述</th><th>必传</th></tr></thead><tbody><tr><td>style</td><td>Object</td><td>-</td><td>样式</td><td>N</td></tr><tr><td>custom-style</td><td>Object</td><td>-</td><td>样式，一般用于开启虚拟化组件节点场景</td><td>N</td></tr><tr><td>offset</td><td>String / Number</td><td>-</td><td>列的偏移量（默认单位px）</td><td>N</td></tr><tr><td>span</td><td>String / Number</td><td>-</td><td>列的宽度（默认单位px）</td><td>N</td></tr></tbody></table><h3 id="row-props">Row Props <a class="header-anchor" href="#row-props"></a></h3><table><thead><tr><th>名称</th><th>类型</th><th>默认值</th><th>描述</th><th>必传</th></tr></thead><tbody><tr><td>style</td><td>Object</td><td>-</td><td>样式</td><td>N</td></tr><tr><td>custom-style</td><td>Object</td><td>-</td><td>样式，一般用于开启虚拟化组件节点场景</td><td>N</td></tr><tr><td>gutter</td><td>String / Number</td><td>-</td><td>列之间的间距（默认单位px）</td><td>N</td></tr></tbody></table>',4),T=[I],B={name:"DESIGN"},V=t("td-doc-empty",null,null,-1),H=[V],U=t("div",{style:{"margin-top":"48px"}},[t("td-doc-history",{time:"1760533894881"})],-1),G=t("td-doc-footer",{slot:"doc-footer",platform:"mobile"},null,-1);function L(o,e,n,d,r,c){const l=f("Stackblitz");return b(),u("td-doc-content",v,[t("td-doc-header",D,null,512),t("td-doc-tabs",{ref:"tdDocTabs",tab:o.tab},null,8,y),s(t("div",null,[t("div",E,[x,t("div",C,[t("td-doc-demo",{code:o.DemoexamplebaseCode,language:"markup","show-code":"",mode:"open","demo-name":"base","component-name":" README"},[t("div",N,[i(l,{"demo-name":"base","component-name":" README",code:o.DemoexamplebaseCode},null,8,["code"])])],8,R)]),A,t("div",M,[t("td-doc-demo",{code:o.DemoexampleoffsetCode,language:"markup","show-code":"",mode:"open","demo-name":"offset","component-name":" README"},[t("div",$,[i(l,{"demo-name":"offset","component-name":" README",code:o.DemoexampleoffsetCode},null,8,["code"])])],8,S)])]),t("td-doc-phone",P,O,512),q],512),[[a,o.tab==="demo"]]),s(t("div",z,T,512),[[a,o.tab==="api"]]),s(t("div",B,H,512),[[a,o.tab==="design"]]),U,G],512)}const K=m(k,[["render",L]]);export{K as default};
