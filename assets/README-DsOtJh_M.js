import{_ as m,d as b,c as h,a as t,w as c,v as i,b as p,e,f as s,r as g,o as k}from"./sites-BI0e1los.js";import{P as v}from"./prism-bash-zcnM7wlG.js";const f=`<template>
  <view>
    <t-tabs
      :default-value="0"
      t-class="custom-tabs"
...
`,D=b({data(){return{DemoexamplebaseCode:f,DemoexamplescrollCode:_,DemoexamplewithiconCode:y,DemoexamplewithbadgeCode:T,DemoexamplewithcontentCode:q,DemoexamplestatusCode:w,DemoexamplesizeCode:x,DemoexamplethemeCode:C}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(n){this.$route.query.tab!==n&&this.$router.push({query:{tab:n}})}}},mounted(){const{tdDocContent:n,tdDocHeader:l,tdDocTabs:o,tdDocPhone:d}=this.$refs,r="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/tabs/tabs";l&&(l.docInfo={title:"Tabs 选项卡",desc:"用于内容分类后的展示切换。"}),o&&(o.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],o.onchange=({detail:u})=>this.tab=u),d&&(d.qrcodeUrl=r),v.highlightAll(),this.$emit("loaded",()=>{n.pageStatus="show"})}}),E={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},A={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"navigation","component-name":"tabs"},M=["tab"],R={name:"DEMO"},S=p(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>全局引入，在 miniprogram 根目录下的<code>app.json</code>中配置，局部引入，在需要引入的页面或组件的<code>index.json</code>中配置。</p><div class="language-json"><pre><code><span class="token property">&quot;usingComponents&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  <span class="token property">&quot;t-tabs&quot;</span><span class="token operator">:</span> <span class="token string">&quot;tdesign-miniprogram/tabs/tabs&quot;</span><span class="token punctuation">,</span>
  <span class="token property">&quot;t-tab-panel&quot;</span><span class="token operator">:</span> <span class="token string">&quot;tdesign-miniprogram/tab-panel/tab-panel&quot;</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="代码演示">代码演示 <a class="header-anchor" href="#代码演示"></a></h2><p><a href="https://developers.weixin.qq.com/s/YR98fimt7MSV" title="在开发者工具中预览效果" target="_blank" rel="noopener noreferrer"> 在开发者工具中预览效果 </a></p><blockquote style="background-color:#d9e1ff;font-size:15px;line-height:26px;margin:16px 0 0;padding:16px;border-radius:6px;color:#0052d9;"><p>Tips: 请确保开发者工具为打开状态。导入开发者工具后，依次执行：npm i &gt; 构建npm包 &gt; 勾选 &quot;将JS编译成ES5&quot;</p></blockquote><h3 id="基础选项卡">基础选项卡 <a class="header-anchor" href="#基础选项卡"></a></h3>`,7),P={class:"tdesign-demo-wrapper tdesign-demo-item-- README-base tdesign-demo-item-- README"},N=["code"],$={slot:"action"},V=t("h3",{id:"等距选项卡"},[s("等距选项卡 "),t("a",{class:"header-anchor",href:"#等距选项卡"})],-1),j={class:"tdesign-demo-wrapper tdesign-demo-item-- README-scroll tdesign-demo-item-- README"},z=["code"],B={slot:"action"},O=t("h3",{id:"带图标选项卡"},[s("带图标选项卡 "),t("a",{class:"header-anchor",href:"#带图标选项卡"})],-1),I={class:"tdesign-demo-wrapper tdesign-demo-item-- README-with-icon tdesign-demo-item-- README"},H=["code"],U={slot:"action"},F=t("h3",{id:"带徽章选项卡"},[s("带徽章选项卡 "),t("a",{class:"header-anchor",href:"#带徽章选项卡"})],-1),G={class:"tdesign-demo-wrapper tdesign-demo-item-- README-with-badge tdesign-demo-item-- README"},J=["code"],Y={slot:"action"},K=t("h3",{id:"带内容区选项卡"},[s("带内容区选项卡 "),t("a",{class:"header-anchor",href:"#带内容区选项卡"})],-1),L={class:"tdesign-demo-wrapper tdesign-demo-item-- README-with-content tdesign-demo-item-- README"},Q=["code"],W={slot:"action"},X=t("h3",{id:"选项卡状态"},[s("选项卡状态 "),t("a",{class:"header-anchor",href:"#选项卡状态"})],-1),Z={class:"tdesign-demo-wrapper tdesign-demo-item-- README-status tdesign-demo-item-- README"},tt=["code"],nt={slot:"action"},at=t("h3",{id:"选项卡尺寸"},[s("选项卡尺寸 "),t("a",{class:"header-anchor",href:"#选项卡尺寸"})],-1),et={class:"tdesign-demo-wrapper tdesign-demo-item-- README-size tdesign-demo-item-- README"},st=["code"],ot={slot:"action"},pt=t("h3",{id:"选项卡样式"},[s("选项卡样式 "),t("a",{class:"header-anchor",href:"#选项卡样式"})],-1),lt=t("p",null,"使用 theme 属性可以变换风格，支持 line = 线条（默认）；tag = 标签；card = 卡片",-1),dt={class:"tdesign-demo-wrapper tdesign-demo-item-- README-theme tdesign-demo-item-- README"},ct=["code"],it={slot:"action"},rt=p(`<img src="https://tdesign.gtimg.com/miniprogram/readme/tabs-3.png" width="375px" height="50%"><h3 id="受控用法">受控用法 <a class="header-anchor" href="#受控用法"></a></h3><div class="language-html"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>t-tabs</span> <span class="token attr-name">value</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>{{value}}<span class="token punctuation">&quot;</span></span> <span class="token attr-name"><span class="token namespace">bind:</span>change</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>onTabsChange<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
