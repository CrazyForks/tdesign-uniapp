import{_ as m,d as g,c as u,a as t,w as c,v as r,b as a,e as s,f as h,r as b,o as f}from"./sites-DRVMbq6-.js";import{P as k}from"./prism-bash-zcnM7wlG.js";const v=`<template>
  <view>
    <t-action-sheet
      id="t-action-sheet"
      ref="t-action-sheet"
...
`,_=g({data(){return{DemoexamplelistCode:v,DemoexamplegridCode:A,DemoexamplestatusCode:y,DemoexamplealignCode:S}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(e){this.$route.query.tab!==e&&this.$router.push({query:{tab:e}})}}},mounted(){const{tdDocContent:e,tdDocHeader:d,tdDocTabs:n,tdDocPhone:i}=this.$refs,l="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/action-sheet/action-sheet";d&&(d.docInfo={title:"ActionSheet 动作面板",desc:"由用户操作后触发的一种特定的模态弹出框 ，呈现一组与当前情境相关的两个或多个选项。"}),n&&(n.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],n.onchange=({detail:p})=>this.tab=p),i&&(i.qrcodeUrl=l),k.highlightAll(),this.$emit("loaded",()=>{e.pageStatus="show"})}}),x={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},w={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"data","component-name":"action-sheet"},D=["tab"],E={name:"DEMO"},T=a(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TActionSheet <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/action-sheet/action-sheet.vue&#39;</span><span class="token punctuation">;</span>
</code></pre></div><h3 id="组件类型">组件类型 <a class="header-anchor" href="#组件类型"></a></h3><p>列表型动作面板</p>`,5),M={class:"tdesign-demo-wrapper tdesign-demo-item-- README-list tdesign-demo-item-- README"},C=["code"],I={slot:"action"},N=t("p",null,"宫格型动作面板",-1),R={class:"tdesign-demo-wrapper tdesign-demo-item-- README-grid tdesign-demo-item-- README"},B=["code"],$={slot:"action"},P=t("h3",{id:"组件状态"},[h("组件状态 "),t("a",{class:"header-anchor",href:"#组件状态"})],-1),z=t("p",null,"宫格型动作面板",-1),L={class:"tdesign-demo-wrapper tdesign-demo-item-- README-status tdesign-demo-item-- README"},j=["code"],q={slot:"action"},O=t("h3",{id:"组件样式"},[h("组件样式 "),t("a",{class:"header-anchor",href:"#组件样式"})],-1),G=t("p",null,"列表型对齐方式",-1),V={class:"tdesign-demo-wrapper tdesign-demo-item-- README-align tdesign-demo-item-- README"},H=["code"],Q={slot:"action"},U=a(`<h3 id="支持指令调用">支持指令调用 <a class="header-anchor" href="#支持指令调用"></a></h3><div class="language-javascript"><pre><code><span class="token keyword">import</span> ActionSheet<span class="token punctuation">,</span> <span class="token punctuation">{</span> ActionSheetTheme <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/action-sheet/index&#39;</span><span class="token punctuation">;</span>
