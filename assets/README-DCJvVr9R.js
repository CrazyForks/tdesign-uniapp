import{_ as p,d as m,c as g,a as t,w as o,v as r,b as d,e as h,f as x,r as u,o as b}from"./sites-DRVMbq6-.js";import{P as f}from"./prism-bash-zcnM7wlG.js";const v=`<template>
  <view class="wrap">
...
`,_=m({data(){return{DemoexamplebaseCode:v,DemoexamplecustomCode:y}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(e){this.$route.query.tab!==e&&this.$router.push({query:{tab:e}})}}},mounted(){const{tdDocContent:e,tdDocHeader:i,tdDocTabs:n,tdDocPhone:s}=this.$refs,a="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/indexes/indexes";i&&(i.docInfo={title:"Indexes 索引",desc:"用于页面中信息快速检索，可以根据目录中的页码快速找到所需的内容。"}),n&&(n.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],n.onchange=({detail:c})=>this.tab=c),s&&(s.qrcodeUrl=a),f.highlightAll(),this.$emit("loaded",()=>{e.pageStatus="show"})}}),w={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},k={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"navigation","component-name":"indexes"},C=["tab"],D={name:"DEMO"},A=d(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TIndexes <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/indexes/indexes.vue&#39;</span><span class="token punctuation">;</span>
