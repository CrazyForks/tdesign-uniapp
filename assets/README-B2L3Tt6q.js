import{_ as h,d as g,c as b,a as e,w as d,v as o,b as l,e as r,f as c,r as u,o as v}from"./sites-Co6lQ2MM.js";import{P as f}from"./prism-bash-zcnM7wlG.js";const x=`<template>
  <view>
...
`,I=g({data(){return{DemoexamplebaseCode:x,DemoexampleswitchCode:w,DemoexamplewithiconCode:y,DemoexamplecustomCode:T}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(n){this.$route.query.tab!==n&&this.$router.push({query:{tab:n}})}}},mounted(){const{tdDocContent:n,tdDocHeader:a,tdDocTabs:t,tdDocPhone:s}=this.$refs,p="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/side-bar/side-bar";a&&(a.docInfo={title:"SideBar 侧边栏",desc:"用于内容分类后的展示切换。"}),t&&(t.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],t.onchange=({detail:m})=>this.tab=m),s&&(s.qrcodeUrl=p),f.highlightAll(),this.$emit("loaded",()=>{n.pageStatus="show"})}}),S={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},_={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"navigation","component-name":"side-bar"},B=["tab"],k={name:"DEMO"},C=l(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TSideBar <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/side-bar/side-bar.vue&#39;</span><span class="token punctuation">;</span>
