import{_ as g,d as h,c as p,a as t,w as a,v as d,b as r,e as m,f as b,r as u,o as f}from"./sites-Co6lQ2MM.js";import{P as v}from"./prism-bash-zcnM7wlG.js";const x=`<template>
  <view>
    <t-message
      id="t-message"
      ref="t-message"
...
`,M=h({data(){return{DemoexamplebaseCode:x,DemoexamplethemeCode:k}},computed:{tab:{get(){return this.$route.query.tab||"demo"},set(e){this.$route.query.tab!==e&&this.$router.push({query:{tab:e}})}}},mounted(){const{tdDocContent:e,tdDocHeader:s,tdDocTabs:n,tdDocPhone:o}=this.$refs,i="https://novlan1.github.io/tdesign-uniapp/mobile#/pages-more/message/message";s&&(s.docInfo={title:"Message 消息通知",desc:"用于轻量级反馈或提示，不会打断用户操作。"}),n&&(n.tabs=[{tab:"demo",name:"示例"},{tab:"api",name:"API"},{tab:"design",name:"指南"}],n.onchange=({detail:c})=>this.tab=c),o&&(o.qrcodeUrl=i),v.highlightAll(),this.$emit("loaded",()=>{e.pageStatus="show"})}}),_={ref:"tdDocContent","page-status":"hidden",platform:"mobile"},y={slot:"doc-header",ref:"tdDocHeader",platform:"mobile",spline:"message","component-name":"message"},w=["tab"],S={name:"DEMO"},D=r(`<h2 id="引入">引入 <a class="header-anchor" href="#引入"></a></h2><p>可在 <code>main.ts</code> 或在需要使用的页面或组件中引入。</p><div class="language-js"><pre><code><span class="token keyword">import</span> TMessage <span class="token keyword">from</span> <span class="token string">&#39;tdesign-uniapp/message/message.vue&#39;</span><span class="token punctuation">;</span>
